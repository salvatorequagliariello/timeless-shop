    ...
    return (
        <div className="mt-24 lg:mt-32 w-[85%] min-[2100px]:w-full mx-auto flex flex-col gap-y-16 flex-wrap text-primary break-words">
            ...
            <div className="flex flex-col gap-y-4 min-[830px]:flex-row w-full lg:h-[450px] gap-x-8">
                <img alt="a wristwatch" src="./assets/images/homepage-content/starfinder-s01.png" className="relative w-full h-[250px] min-[670px]:h-[300px] lg:h-full min-[830px]:w-[50%] object-cover"/>
            ...
            <div className="flex flex-col gap-y-4 min-[830px]:flex-row-reverse w-full lg:h-[450px] gap-x-8">
                <img alt="a wristwatch" key={1} src="./assets/images/homepage-content/planetocean-p97.webp" className="w-full h-[250px] min-[670px]:h-[300px] lg:h-full min-[830px]:w-[50%] object-cover"/>
