...
const CategoryPage: React.FC<CategoryPageProps> = async ({
    ...
    return (
        <div className="max-w-[1920px] min-[2100px]:w-full pt-24 mx-auto flex flex-col gap-y-4 text-primary font-primaryb">
            <CategoryHeader imgUrl={category.billboard.imageUrl} categoryName={`${category.name} Collection`} />
            <div className="w-[85%] min-[2100px]:w-full mx-auto">
                <hr className="my-4"/>
                <div>
