...
type CSSProperties = Properties & Record<`--${string}`, string>;
...
type ResolvableTo<TResult> = TResult | ((theme: (path: ConfigDotNotationPath) => TResult, utils: ConfigUtils) => TResult);
type BaseConfig = {
...
type PurgeConfig = Array<string> | false | {
    enabled: boolean;
...
type ContentConfig = Array<string> | {
    files: Array<string>;
...
type BaseThemeConfig = {
    ...
    /** Components */
    container: Partial<{
        screens: Array<string> | Record<string, {
            min: string;
            max: string;
...
type VariantsAPI = {
    ...
    before: (toInsert: Array<string>, variant?: string, existingPluginVariants?: Array<string>) => Array<string>;
    after: (toInsert: Array<string>, variant?: string, existingPluginVariants?: Array<string>) => Array<string>;
    without: (toRemove: Array<string>, existingPluginVariants?: Array<string>) => Array<string>;
};
type VariantsConfig = Array<string> | Record<string, Array<string> | ((api: VariantsAPI) => Array<string>)> | {
    extend: Record<string, Array<string>>;
};
type CorePluginsConfig = Array<string> | Record<string, boolean>;
type VariantConfig = Array<string> | Partial<{
    variants: Array<string>;
    respectPrefix: false;
    respectImportant: false;
}>;
type ValueType = 'absolute-size' | 'any' | 'color' | 'family-name' | 'generic-name' | 'image' | 'length' | 'line-width' | 'lookup' | 'number' | 'percentage' | 'position' | 'relative-size' | 'url';
type PluginAPI = {
    /** Get access to the whole config */
    config: <TDefaultValue = TailwindConfig>(path?: ConfigDotNotationPath, defaultValue?: TDefaultValue) => TDefaultValue;
    /** Escape classNames */
    ...
    variants: <TDefaultValue>(path: ConfigDotNotationPath, defaultValue: TDefaultValue) => TDefaultValue;
    ...
    addVariant: (name: string, generator: (api: {
        container: postcss.Container;
        separator: string;
        modifySelectors: (modifierFunction: (api: {
            className: string;
            selector: string;
        }) => void) => void;
    }) => void) => void;
    matchUtilities: <T = string>(utilities: Record<string, (value: T) => CSSProperties>, options?: Partial<{
...
type PluginsConfig = Array<PluginCreator | {
    handler: PluginCreator;
    config?: TailwindConfig;
}>;
/** The holy grail Tailwind config definition */
type TailwindConfig = Partial<BaseConfig & Record<string, unknown> & {
...
export { BaseConfig, BaseThemeConfig, CSSBlock, CSSProperties, ConfigDotNotationPath, ConfigUtils, ContentConfig, CorePluginsConfig, DarkModeConfig, EntryPoint, ExperimentalConfig, FutureConfig, KeyValuePair, Keyframes, PluginAPI, PluginCreator, PluginsConfig, PurgeConfig, ResolvableTo, TailwindConfig, ThemeConfig, ValueType, VariantConfig, VariantsAPI, VariantsConfig, withAnimations };
